# modified for DPNeurifyFV experiments
'''
...
def main():
    ...
    processes = 1  # only single threaded
    ...
    with open(hard_filename, "w") as h:
        with open(full_filename, "w") as f:
            for instance in instances:
                ...
                res_str, secs = verify_acasxu(net_pair, spec, timeout, processes)
...
def verify_acasxu(net_pair, spec, timeout, processes):
    ...
    args = [sys.executable, '-m', 'nnenum.nnenum', onnx_path, spec_path, f'{timeout}', 'out.txt', f'{processes}']
